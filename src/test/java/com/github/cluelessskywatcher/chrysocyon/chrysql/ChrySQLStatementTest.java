...
import com.github.cluelessskywatcher.chrysocyon.chrysql.ddl.CreateTableResult;
...
public class ChrySQLStatementTest {
    ...
    public void init() {
        ...
        CreateTableResult crtTable1 = (CreateTableResult) ChrySQLUtils.execute(
            "create table human_species (int species_number, varstr(100) scientific_name);", db, transaction
        );
        System.out.println(crtTable1.getRows());
